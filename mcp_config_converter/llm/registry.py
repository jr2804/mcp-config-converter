...
def register_provider(provider_name: str, cost: int = 10) -> Any:
...
def get_provider_info(provider_name: str) -> ProviderInfo | None:
    """Get provider info by name."""
    return _PROVIDER_REGISTRY.get(provider_name)


def get_provider(provider_name: str) -> type["BaseLLMProvider"] | None:
...
def _create_custom_provider(provider_name: str, **kwargs: Any) -> "BaseLLMProvider":
